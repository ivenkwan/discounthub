              ...
              <v-card>
                ...
                <v-fade-transition>
                  <v-overlay
                    ...
                    absolute
                  >
                    <v-btn x-large rounded :to="{ name: 'admin.users' }" class="ctaBg ctaFg--text">{{ $t('more') }} <v-icon size="15" class="ml-1">mdi-arrow-right</v-icon></v-btn>
                  </v-overlay>
                </v-fade-transition>
              </v-card>
            </template>
              ...
              <v-card>
                ...
                <v-fade-transition>
                  <v-overlay
                    ...
                    absolute
                  >
                    <v-btn x-large rounded :to="{ name: 'settings.profile' }" class="ctaBg ctaFg--text">{{ $t('more') }} <v-icon size="15" class="ml-1">mdi-arrow-right</v-icon></v-btn>
                  </v-overlay>
                </v-fade-transition>
              </v-card>
            </template>
