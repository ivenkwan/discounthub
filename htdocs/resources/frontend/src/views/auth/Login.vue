                        ...
                        <v-card flat tile class="content-tabs-card pa-5 mb-0 mb-md-12">
                          <v-card-text>
                            ...
                            <x-checkbox
                              ...
                              dense
                            />
                            <v-btn color="ctaBg ctaFg--text" class="no-caps mb-3" block x-large depressed tile :loading="form1.loading" :disabled="form1.loading || invalid" type="submit">{{ $t('log_in') }} <v-icon right>mdi-arrow-right</v-icon></v-btn>
                            <div>
                              {{ $t('dont_have_account') }} <router-link :to="{name: 'register'}">{{ $t('sign_up') }}</router-link>
                            </div>
                          </v-card-text>
                        </v-card>
                      </v-form>
